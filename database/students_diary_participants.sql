...
CREATE TABLE `participants` (
  `idEvent` int NOT NULL COMMENT 'Ключ мероприятия',
  ...
  KEY `id-event_idx` (`idEvent`),
  KEY `id-owner_idx` (`idOwner`),
  CONSTRAINT `id-event` FOREIGN KEY (`idEvent`) REFERENCES `events` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `participants` VALUES (8,1,0);
...
-- Dump completed on 2021-05-14 18:15:36
