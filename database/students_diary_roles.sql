...
CREATE TABLE `roles` (
  ...
  `address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'Адрес обращения к данной роли',
  PRIMARY KEY (`id`)
...
INSERT INTO `roles` VALUES (1,'Студент','student/'),(2,'Преподаватель','teacher/');
