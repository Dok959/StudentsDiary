...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Таблица пользователей';
...
INSERT INTO `users` VALUES (1,'admin','admin'),(12,'dok123','12345'),(13,'user_1','ghggtyghyy');
